...
public:
	...
	void render() {
		glColor3f(0.4, 0.2, 0); Square(vertices[0], vertices[1], vertices[2], vertices[3]); // front
		glColor3f(0.4, 0.2, 0); Square(vertices[4], vertices[5], vertices[6], vertices[7]); // back
//		glColor3f(0.5, 0, 1); Square(vertices[0], vertices[1], vertices[5], vertices[4]); // top
//		glColor3f(0.5, 0, 1); Square(vertices[3], vertices[2], vertices[6], vertices[7]); // bottom
		glColor3f(0.5, 0.3, 0); Square(vertices[0], vertices[3], vertices[7], vertices[4]); // left
		glColor3f(0.5, 0.3, 0); Square(vertices[1], vertices[5], vertices[6], vertices[2]); // right
	}
