...
public:
	...
	void render() {
		glColor3f(0.5, 0, 0); Square(vertices[0], vertices[1], vertices[2], vertices[3]); // front
		glColor3f(0.5, 0, 0); Square(vertices[4], vertices[5], vertices[6], vertices[7]); // back
		...
		glColor3f(0, 0, 0.5); Square(vertices[0], vertices[3], vertices[7], vertices[4]); // left
		glColor3f(0, 0, 0.5); Square(vertices[1], vertices[5], vertices[6], vertices[2]); // right
	}
